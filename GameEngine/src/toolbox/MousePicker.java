...
public class MousePicker {
	...
	private Vector3f calculateMouseRay() {
		...
		Vector2f normalizedCoords = getNormailzeDeviceCoords(mouseX, mouseY);
	...
	private Vector2f getNormailzeDeviceCoords(float mouseX, float mouseY) {
